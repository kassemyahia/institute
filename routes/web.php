...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/top-students', [HomeController::class, 'topStudents'])->name('top_students.index');
    ...
    Route::get('/grades', [StudentGradeController::class, 'index'])->name('student_grade.index');
    Route::get('/grades/create', [StudentGradeController::class, 'create'])->name('student_grade.create');
    Route::post('/grades', [StudentGradeController::class, 'store'])->name('student_grade.store');
